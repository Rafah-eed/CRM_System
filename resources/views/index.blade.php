...
<body>
	<div id="background">
		<div id="page">
			<div id="header">
				<div id="logo">
					<a href="index.html"><img src="images/logo.webp" alt="LOGO" height="112" width="118"></a>
				</div>
				<div id="navigation">
					<ul>
						<li class="selected">
						...
						<li>
							<a href="income.html">Rooms</a>
						</li>
						<li>
							<a href="expenses.html">Dive Site</a>
						</li>
						<li>
			...
			<div id="contents">
				<div id="adbox">
					<img src="images/bg.jpg" alt="Img"  height="400" width="600">
